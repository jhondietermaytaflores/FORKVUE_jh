    ...
    <div class="container">
      ...
      <div class="stats-card">
        ...
        <div class="progress-track" v-if="totalTasks > 0">
          <div 
            ...
            :class="{ 'is-completed': progressPercentage === 100 }"
          ></div>
        </div>
      </div>
      ...
      <ul v-else class="task-list">
        ...
        >
          ...
          >
            <svg class="btn-delete-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <footer class="footer-info">
        <span>{{ completedTasks === totalTasks && totalTasks > 0 ? '🎉 ¡Felicidades! Has completado todas tus tareas' : 'Haz clic en la casilla para marcar una tarea como completada' }}</span>
      </footer>
    </div>
  </div>
</template>
